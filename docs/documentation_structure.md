...
- `docs/step7_gui_shell.md` – Step 7 kickoff covering the preview orchestrator, tracker/mixer layout contracts, tracker grid & loudness widgets, and widget bindings promoted from the mock into production.
